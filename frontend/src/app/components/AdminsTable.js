  ...
  {loading ? (
    ...
    <div>
      {adminsData.length > 0 ? (
        ...
        <div className='center'> <div className='none-message'>No admins found.</div></div> 
      )}
    </div>
  )}
    ...
    <div className="modal-overlay">
      <div className="modal-content">
        <div className="confirmation-message">
          Are you sure you want to delete <div style={{ fontWeight: "bold" }}>{adminToDelete} <span>?</span></div>
        </div>
